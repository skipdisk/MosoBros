...
class TileProcessor: 
	...
	#crops the image and converts it to RGB format
...
def build_mosaic(result_queue, all_tile_data_large, original_img_large, file_name):
	...
	mosaic.save('/Users/skipdisk/Desktop/csci/MosoBros/services/mosaic/'+ file_name)
	print('http://localhost:5000/services/mosaic/'+file_name)

def compose(original_img, tiles, file_name):
	...
	try:
		...
		Process(target=build_mosaic, args=(result_queue, all_tile_data_large, original_img_large, file_name)).start()
